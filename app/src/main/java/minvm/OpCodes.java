...
public enum OpCodes {
    ...
    //virtual command:
    //adds a tag to Program CodeManager
    //:tag [name]
    TAG,
    ...
    //if (optional var): [code chunk]
    /*
    Like this:
    if:
     new-int 'exit_status 0
     call-static 'java.lang.System exit exit_status
     */
    IFEVAL,
    IFNOTEVAL,
    //if error != null
    ...
    //like ^
    COLUMN,
    //Used by MinVM Garbage Collector and stack backtrace
    //:scope function_foo
    SCOPE,
    //:scope-end function_foo
    SCOPE_END;
